    ...
    <section id="services" className="services-section py-5">
      <div className="container text-center">
        ...
        <p
          ...
          dir="rtl"
        >
          في Digital Solutions، بنقدملك حلول برمجية متكاملة تناسب احتياجاتك،
          سواء كنت شركة، فريلانسر، أو صاحب مشروع ناشئ. اختار من بين خدمات متنوعة
          تم تصميمها بعناية لتناسب مجالك.
        </p>
